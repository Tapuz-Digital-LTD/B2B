...
// the answers are editable placeholders — the Figma design shows the list collapsed
const faqs = [
  {
  ...
  {
    q: 'מהו הזמן האידיאלי לשליחת מתנות פסח לעובדים?',
  ...
  {
    q: 'חלק מהעובדים משתייכים למגזר החרדי. האם גם הם יהיו מרוצים מהמתנה לפסח?',
